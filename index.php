...
<script>
  window.callbellSettings = {
    token: "NSSsavLoUbYgdtTBuNZfLE3x"
  };
</script>
<script>
      ...
      function sendData()
{
  ...
  $.ajax({
    ...
    success: function (response) {
      $('#res').html("Votre Message à été bien envoyé ! Merci");
    }
  });
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarTogglerDemo01">
					...
					<ul class="navbar-nav ml-auto align-items-center">
						...
						<li class="nav-item">
							<a class="nav-link" href="#testimonial">Avis Clients</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="#plans">Offres</a>
						</li>
						<li class="nav-item">
							<a class="nav-link btn btn-success" href="#contact">Contactez-nous</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="page-body-wrapper">
							...
							<div class="main-banner">
								<div class="d-sm-flex justify-content-between">
									...
									<div class="mt-5 mt-lg-0">
										<img src="images/group.png" alt="imageweb" class="img-fluid" data-aos="zoom-in-up" style="width: 700px; height: 300px;">
									</div>
								</div>
							</div>
						</div>
			...
			<section class="our-services" id="services">
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<h5 class="text-dark">Nous vous offrons avec</h5>
							<h3 class="font-weight-medium text-dark mb-5">Reality Tech</h3>
						</div>
					</div>
					<div class="row" data-aos="fade-up">
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								...
								<h6 class="text-dark mb-3 mt-4 font-weight-medium">Conception de Site Web Vitrine, Portfolio et Ecommerce
								</h6>
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box"   data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								...
								<h6 class="text-dark mb-3 mt-4 font-weight-medium">Web Design & 
									Development
								</h6>
								<p>Lorem ipsum dolor sit amet, 
									pretium pretium tempor.Lorem ipsum 
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								...
								<h6 class="text-dark mb-3 mt-4 font-weight-medium">Référencement SEO
								</h6>
								<p>Lorem ipsum dolor sit amet, 
									pretium pretium tempor.Lorem ipsum 
								</p>
					...
					<div class="row" data-aos="fade-up">
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box  pb-lg-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								...
								<h6 class="text-dark mb-3 mt-4 font-weight-medium">Digital 
									Marketing / Réseaux Sociaux / Community Management
								</h6>
								<p>Lorem ipsum dolor sit amet, 
									pretium pretium tempor.Lorem ipsum 
								</p>
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box pb-lg-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								...
								<h6 class="text-dark mb-3 mt-4 font-weight-medium">Développement de Logiciels sur mesure et d'Applications Web ou Mobile
								</h6>
								<p>Lorem ipsum dolor sit amet, 
									pretium pretium tempor.Lorem ipsum 
								</p>
						...
						<div class="col-sm-4 text-center text-lg-left">
							<div class="services-box pb-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
								...
								<h6 class="text-dark mb-3 mt-4 font-weight-medium">Plateforme Web tout en un (Sreaming / Vente en ligne / Blog / Reservation en ligne,etc)
								</h6>
								<p>Lorem ipsum dolor sit amet, 
									pretium pretium tempor.Lorem ipsum 
								</p>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-6" data-aos="fade-up">
							<h5 class="text-dark">Notre processus de travail :</h5>
							<h3 class="font-weight-medium text-dark">Découvrez avec nous, une chance de transformer tous vos projets web en REALITE !</h3>
							<h5 class="text-dark mb-3">L'imagination nous emmènera partout</h5>
							<p class="font-weight-medium mb-4">Nous utilisons un processus de travail <br> qui vous met, vous le client, au centre de la conception des plateformes, en nous basant sur vos gouts et desirs les plus fous.
							</p>
							<div class="d-flex justify-content-start mb-3">
								<img src="images/tick.png" alt="tick" class="mr-3 tick-icon"  >
								<p class="mb-0">Parlez nous de votre désir, de ce que vous souhaitez qu'on vous réalise, comme plateforme web</p>
							</div>
							<div class="d-flex justify-content-start mb-3">
								<img src="images/tick.png" alt="tick" class="mr-3 tick-icon"  >
								<p class="mb-0">Accordez nous votre confiance, pour que l'équipe fasse tout pour concevoir exactement votre plateforme</p>
							</div>
							<div class="d-flex justify-content-start">
								<img src="images/tick.png" alt="tick" class="mr-3 tick-icon"  >
								<p class="mb-0">Soyez Patient ! Nous respectons votre délai de livraison. Entierement satisfait ou Remboursé</p>
							</div>
						</div>
					...
					<div class="row mb-5">
						<div class="col-sm-12">
							<div class="d-sm-flex justify-content-between align-items-center mb-2">
								<h3 class="font-weight-medium text-dark ">Nos récents projets</h3>
						...
						<div class="col-sm-3">
							<div class="d-flex py-3 my-3 my-lg-0 justify-content-center" data-aos="fade-down">
								...
								<div>
									...
									<h5 class="text-dark mb-0">Clients Satisfaits</h5>
								</div>
							</div>
						</div>
						<div class="col-sm-3">
				...
				<div class="container">
					<div class="row  mt-md-0 mt-lg-4">
						<div class="col-sm-6 text-white" data-aos="fade-up">
							<p class="font-weight-bold mb-3">Témoignages Clients</p>
							<h3 class="font-weight-medium">Nos clients sont fiers
                            <br> de nous !</h3>
								...
								<ul>
									<li>
										<div class="testimonial-item">
											...
											<p>Realty Tech est l'agence web auquel j'ai confié la conception du site web de ma premiere Start-Up. Ils se sont bien occupés, coté web design, et visibilité SEO. Je vous le recommande.
											</p>
									...
									<li>
										<div class="testimonial-item">
											...
											<p>Confiez la conception et la création de vos plateformes web (site vitrine, portfolio personnel, e-commerce, etc), est la meilleure des choses que vous puissiez faire. <I>ls prennent au sérieux les besoins réels du clients ainsi que ses désirs. N'hesitez donc pas à les faire confiance.</I>
											</p>
									...
									<li>
										<div class="testimonial-item">
											...
											<p> Ces gars sont les meilleurs en matieres de conception web. J'avais un site ecom mal concu récemment par un mauvais développeur. J'étais sceptique de leur faire confiance, mais en moins d'une semaine, mon site etait pret avec un réferencement de ouff sur Google, ce qui a augmenter le trafic vers les produits de mon site ecom. Je vous le recommande vivement !
											</p>
									...
									<li>
										<div class="testimonial-item">
											...
											<p> Reality Tech ! C'est du REVE à la REALITE vraiment. Respect du temps de conception, Respect de tous les détails du Client, Plateforme ultra optimisé. C'est juste les meilleurs.
											</p>
											<h6 class="testimonial-author">Mark Spenser</h6>
											<p class="testimonial-destination">Director,Dj market</p>
										</div>
				...
				<div class="container">
					<div class="row" data-aos="fade-up" data-aos-offset="-500">
						<div class="col-sm-12">
							<div class="d-sm-flex justify-content-between align-items-center mb-2">
								<div>
									<h3 class="font-weight-medium text-dark ">Nos Offres et Prix</h3>
									<h5 class="text-dark ">Avec un respect des délais de livraison, des détails de conception et la qualité premium de toutes nos conceptions, nous disposons encore mieux, des MEILLEURS PRIX du secteur du développemnt web ! </h5>
								</div>
						...
						<div class="col-sm-7" data-aos="fade-up" data-aos-offset="-500">
							...
							<form method="POST">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="form-group">
											<input type="email" class="form-control" name="email" id="mail" placeholder="Adresse Email**" required="">
										</div>
									</div>
									<div class="col-sm-12">
										<div class="form-group">
											<textarea name="message" id="message" class="form-control" placeholder="Ecrivez votre Message**" rows="5" required=""></textarea>
										</div>
									</div>
									<div class="col-sm-12">
										<input type="submit" name="envoyez" class="btn btn-secondary" value="ENVOYEZ">
									</div>
									<h4 id="res">
